        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          >
            <Button
              onClick={onCreateBot}
              size="lg"
              className="bg-gradient-primary hover:opacity-90 text-white px-8 py-6 text-lg rounded-xl shadow-strong hover:shadow-strong transition-all group animate-[btn-breathe_3s_ease-in-out_infinite] hover:animate-none [&@keyframes_btn-breathe]:{}"
