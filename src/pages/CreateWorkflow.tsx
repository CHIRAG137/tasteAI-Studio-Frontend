...
//                 <Card
//                   key={wt.type}
//                   className={`cursor-pointer transition-all hover:shadow-[var(--shadow-soft)] ${selectedType === wt.type
...
//                       <div
//                         className={`p-3 rounded-xl ${selectedType === wt.type ? "bg-primary/10" : "bg-muted"
//                           }`}
//                       >
//                         <wt.icon
//                           className={`w-6 h-6 ${selectedType === wt.type ? "text-primary" : "text-muted-foreground"
//                             }`}
//                         />
//                       </div>
...
import { Button } from "@/components/ui/button";
import { Navbar } from "@/components/Navbar";
import { Zap, ArrowLeft, Bell } from "lucide-react";
...
export default function CreateWorkflow() {
  ...
  return (
    <div className="min-h-screen bg-muted/30">
      <Navbar pageTitle="Create Workflow" />
      ...
      <div className="max-w-2xl mx-auto px-4 py-32 flex flex-col items-center text-center">
        ...
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-100 text-amber-700 text-xs font-semibold mb-5 dark:bg-amber-900/30 dark:text-amber-400">
          <span className="w-1.5 h-1.5 rounded-full bg-amber-500 animate-pulse" />
          Coming Soon
        </div>

        <h1 className="text-3xl font-bold text-foreground mb-3">Slack Workflow Builder</h1>
        <p className="text-muted-foreground text-base leading-relaxed mb-8 max-w-md">
          We're rebuilding the workflow builder from the ground up to give you a faster, more powerful experience. It'll be worth the wait.
        </p>

        <div className="flex flex-col sm:flex-row gap-3">
          <Button variant="outline" onClick={() => navigate("/workflows")} className="gap-2">
