    ...
    const fetchBot = async () => {
      try {
        ...
        setBotConfig({
          ...
          primaryPurpose: bot.primary_purpose || "customer-support",
          specializationArea: bot.specialisation_area || "",
          conversationalTone: bot.conversation_tone || "professional",
          responseStyle: bot.response_style || "concise",
          targetAudience: bot.target_audience || "customers",
